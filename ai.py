...
reply_cache = {}
image_cache = {}
conversation_history = defaultdict(list)  # Per-user conversation history for Gemini
...
# Message Handler with Gemini Enhancement
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.chat.type == "private" and not is_clone:
        ...
        if not gemini_reply and random.random() < 0.5:
